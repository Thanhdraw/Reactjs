...
// https://api.themoviedb.org/3/movie/343611?api_key=96ec101a998857c1e18047b0677bf26d
// https://api.themoviedb.org/3/movie/343611?api_key=96ec101a998857c1e18047b0677bf26d&query=''
const Movies = () => {
  const [movies, setMovies] = useState([]);
  const [query, setQuery] = useState("");
  const [loading, setLoading] = useState(true);
  const queryDebounce = useDebounce();
  useEffect(() => {
    async function fetchData() {
      setLoading(true);
      const response = await axios.get(
        `https://api.themoviedb.org/3/movie/343611?api_key=96ec101a998857c1e18047b0677bf26d&query='${queryDebounce}'`
      );
...
// https://image.tmdb.org/t/p/original/8rXOIQmdXMMXcDtvrs5O74BUICP.jpg
 */
